  ...
  return (
    <section id='team' className='section'>
      <div className='container mx-auto text-center'>
        <h2 className='text-5x1 font-primary font-extrabold mb-4'>Our Attourneys</h2>
        <p className='max-w-[540px] mx-auto px-6 lg:px-0mb-[60px]'>
        ...
        <div className='lg:grid lg:grid-cols-3 lg:gap-x-[30px]'>
            ...
            return( <div className='text-center lg:text-left mb-12' key={index}>
                ...
                <h4 className='text-2x1 md-2 font-primary font-bold'>{name}</h4>
